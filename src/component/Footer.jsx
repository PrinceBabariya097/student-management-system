...
function Footer() {
  return (
    <footer className=' w-full bg-[#E6E6E7] relative flex flex-col '>
      <div className='flex justify-around mt-10'>
        <div className='text-xs w-[286px] '>
          <img src={logo} alt="" /><br />
        ...
        <div>
          <p className='font-bold text-base pb-2'>Halaman Umum</p>
      ...
      <div className='h-[1px] mx-auto mt-6 border border-solid border-slate-300' id='spaceLine'></div>
        <div>
          <p className='text-xs py-5 pl-[105px] '>
